...
# SummaryDAO
##############
SummaryDAO.selectAllRecipients = SELECT username, user_email FROM jforum_users WHERE user_email != '' and deleted IS NULL OR deleted = 0 ORDER BY user_posts DESC 
